...
# predicts persona using castlevania dialogue dataset
...
weights_file = 'my_model_weights21_reverse_original.h5'
...
with open("context_castlevania", "r", encoding="utf-8") as input_file:
    with open("predicted_castlevania", "w", encoding="utf-8") as output_file:
