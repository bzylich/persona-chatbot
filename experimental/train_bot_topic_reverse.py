...
questions_file = 'Padded_context_reverse'
answers_file = 'Padded_answers_reverse'
weights_file = 'my_model_weights20_reverse_original.h5' # CHANGE THIS FOR EACH NEW MODEL BAAAAKAAAA
GLOVE_DIR = './glove.6B/'
...
indices = np.arange(0, np.shape(q)[0])
